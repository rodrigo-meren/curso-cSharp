    ...
    class Program
    {
        static void Main(string[] args)
        {
           // 3. Una importante marca de computadoras permite elegir cierta configuración del equipo a comprar. Para ello existe la siguiente escala de precios:
            ...
            int procesador,ram,disco,total;

            Console.WriteLine("ingrese el procesador deseado");
            procesador = int.Parse(Console.ReadLine());
            Console.WriteLine("ingrese la memoria deseada:");
            ram = int.Parse(Console.ReadLine());
            Console.WriteLine("quiere extender la capacidad del disco duro? ");
            ...
            switch(procesador){
                ...
                switch(ram){
                    ...
                    total = 1000;
                        break;
                    default:
                    Console.WriteLine("ingrese una opcíon valida");
                        break;
                }
                    break;
                case 2:
                ...
                total = total + 300;
                 ...
                 Console.WriteLine("El total a pagar es de: " + total + "USD");     
            }
        }
    }
}
